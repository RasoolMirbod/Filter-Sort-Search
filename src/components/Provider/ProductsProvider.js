...
const ProductContex = React.createContext(); //state
const ProductContexDispatcher = React.createContext(); //setState()
// const initialState = [
...
const ProductsProvider = ({ children }) => {
  ...
  return (
    <ProductContex.Provider value={products}>
      <ProductContexDispatcher.Provider value={dispatch}>
        {children}
...
export const useProducts = () => useContext(ProductContex);

export const useProductsActions = () => {
  return useContext(ProductContexDispatcher);
};
